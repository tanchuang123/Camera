...
QT_MOC_LITERAL(4, 29, 14) // "disconnectSlot"

    },
    "MyThread\0transmitData\0\0image\0"
    "disconnectSlot"
};
...
void MyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->transmitData((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::transmitData)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyThread::disconnectSlot)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyThread::transmitData(QImage _t1)
{
